      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-start justify-between md:p-20 pt-20 pb-12 px-4">
          <div className="md:pt-32 space-y-6 flex flex-1 flex-col justify-start items-start">
            ...
            <button onClick={handleGetStarted} className="py-2.5 px-3 lg:px-6 flex items-center bg-[#1B5FFE] hover:bg-[#0A3D91] rounded-xl text-white text-base font-bold hover:shadow-none cursor-pointer transition-all duration-300">
